...
```bash
npx skills add "https://github.com/frayer/skills-monorepo-demo#skills/skill-hello/v1.2.0" --skill skill-hello
```

That install pattern makes the release model explicit:

- the Git repository is the source
- `skills/skill-hello/v1.2.0` is the immutable ref being installed
